...
To build the final jar and optimize the infirmerieApp application for production, run:
...
Then navigate to [http://localhost:9006](http://localhost:9006) in your browser.
