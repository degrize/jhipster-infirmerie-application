...
import com.ingstic2.myapp.domain.Service;
import com.ingstic2.myapp.repository.ServiceRepository;
...
class ServiceResourceIT {
    ...
    public static Service createEntity(EntityManager em) {
        Service service = new Service().nom(DEFAULT_NOM);
        return service;
    }
    ...
    public static Service createUpdatedEntity(EntityManager em) {
        Service service = new Service().nom(UPDATED_NOM);
        return service;
    }
    ...
    void putExistingService() throws Exception {
        ...
        updatedService.nom(UPDATED_NOM);
    ...
    void fullUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.nom(UPDATED_NOM);
