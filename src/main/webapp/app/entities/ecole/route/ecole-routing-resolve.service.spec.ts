...
describe('Ecole routing resolve service', () => {
  ...
  let resultEcole: IEcole | null | undefined;
  ...
  describe('resolve', () => {
    it('should return IEcole returned by find', () => {
      ...
      expect(resultEcole).toEqual({ id: 123 });
    });
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultEcole).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IEcole>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
