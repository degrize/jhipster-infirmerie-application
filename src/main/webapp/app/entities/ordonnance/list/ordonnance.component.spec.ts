...
describe('Ordonnance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ordonnance', component: OrdonnanceComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to ordonnanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrdonnanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrdonnanceIdentifier).toHaveBeenCalledWith(entity);
