...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../ordonnance.test-samples';

import { OrdonnanceService } from './ordonnance.service';

const requireRestSample: IOrdonnance = {
...
describe('Ordonnance Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a Ordonnance', () => {
      ...
      const ordonnance = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(ordonnance).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a Ordonnance', () => {
      const ordonnance = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(ordonnance).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addOrdonnanceToCollectionIfMissing', () => {
      it('should add a Ordonnance to an empty array', () => {
        const ordonnance: IOrdonnance = sampleWithRequiredData;
      ...
      it("should add a Ordonnance to an array that doesn't contain it", () => {
        const ordonnance: IOrdonnance = sampleWithRequiredData;
        const ordonnanceCollection: IOrdonnance[] = [sampleWithPartialData];
        expectedResult = service.addOrdonnanceToCollectionIfMissing(ordonnanceCollection, ordonnance);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(ordonnance);
      });
      ...
      it('should add only unique Ordonnance to an array', () => {
        const ordonnanceArray: IOrdonnance[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const ordonnanceCollection: IOrdonnance[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const ordonnance: IOrdonnance = sampleWithRequiredData;
        const ordonnance2: IOrdonnance = sampleWithPartialData;
    ...
    describe('compareOrdonnance', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareOrdonnance(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareOrdonnance(entity1, entity2);
        const compareResult2 = service.compareOrdonnance(entity2, entity1);
